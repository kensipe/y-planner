            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="project.archived.label" default="Archived" /></td>
                            
                            <td valign="top" class="value"><g:formatBoolean boolean="${projectInstance?.archived}" /></td>
